...
$this->data .= "</div></td><td id='co-right'><div id='bigi'>RECEIPT</div><div id='invinfo'>";
...
// (F) ITEMS
$this->data .= "<table id='items'><tr><th>Purpose</th><th></th><th></th><th>Amount</th></tr>";
...
// (I) CLOSE
$this->data .= "</div></div><img src='../../../logos/print.png' onClick='window.print()' class='float'/></body></html>";