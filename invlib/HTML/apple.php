...
"html,body{font-family:sans-serif}#invoice{max-width:800px;margin:0 auto}#billship,#company,#items{width:100%;border-collapse:collapse}#company td,#billship td,#items td,#items th{padding:15px}#company,#billship{margin-bottom:30px}#company img{max-width:180px;height:auto}#bigi{font-size:28px;color:black}#billship{background:green;color:#fff}#billship td{width:33%}#items th{text-align:left;border-top:2px solid green;border-bottom:2px solid green}#items td{border-bottom:1px solid green}.idesc{color:#ca3f3f}.ttl{font-weight:700}.right{text-align:right}#notes{margin-top:30px;font-size:.95em}.float{
	position:fixed;
	width:40px;
	height:40px;
	padding:8px;
...
$this->data .= "<div id='bigi'>INVOICE</div>";
...
// (F) ITEMS
$this->data .= "<table id='items'><tr><th>Service</th><th>Units</th><th>Unit Price</th><th>Amount</th></tr>";
